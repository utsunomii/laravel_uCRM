...
import BreezeValidation from '@/Components/ValidationErrors.vue';
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    <label for="customer" class="leading-7 text-sm text-gray-600">会員名</label>
                                         <input disabled type="text" id="date" name="date" :value="props.order[0].customer_name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                  </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    <label for="status" class="leading-7 text-sm text-gray-600">ステータス</label>
                                         <input  type="radio" id="date" name="status" :value="props.order[0].status_name" >未キャンセル
                                         <input  type="radio" id="date" name="status" :value="props.order[0].status_name" >キャンセルする
                                  </div>
                                </div>
                                <div class="p-2 w-full">
