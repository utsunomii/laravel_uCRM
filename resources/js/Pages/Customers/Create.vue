...
const form = reactive({
    name: null, tel: null, email: null, postcode: null, address: null, birthday: null, gender: null, memo: null
});
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="radio" id="gender0" name="gender" v-model="form.gender" value="1">
